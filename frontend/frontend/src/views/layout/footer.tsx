        ...
        <div className="container">
            <div className="row">
               <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                    ...
                    BKS MarketPlace is q one-stop-shop for everyone in the industry, the BKS Marketplace lists ticket
sales, NFT drops, advertising opportunities &amp; more
                    </p> 
                    <br />
                    <br />
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="footer__content">
                            ...
                            <small className="footer__copyright">© Backstage, 2022. Created by <a
