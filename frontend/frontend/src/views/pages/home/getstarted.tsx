        ...
        <div className="row row--grid">
            ...
            <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                <div className="feature">
                    ...
                    <p className="feature__text">
                        ...
                        By visiting Backstage NFT public web page, anybody 
                        can register on Backstage’s NFT Marketplace. The registration process is intuitive
                         and requires downloading BKS Wallet. Once compliant with the mandatory KYC &amp;
                          AML procedures, user will be enabled to collect, buy, and sell NFTs.</p>
                </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                <div className="feature">
                    ...
                    <p className="feature__text">Connected with BKS Wallet, Backstage’s NFT Platform will help the Event Industry to fight counterfeiting and fraud on ticket sales: by adopting trusted real-time 
                    payments proceeding from ticket sales and bookings of services. <br/><a href="signin.html">Connect my wallet</a>.</p>
                </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                <div className="feature">
                    ...
                    <p className="feature__text">Backstage’s NFT Platform provides the possibility to mint digital assets for users to build, purchase, and sell NFTs
                     traded against the BKS token, and to also provide additional services.</p>
                </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                <div className="feature feature--last">
                    ...
                    <p className="feature__text">Furthermore, the NFT Platform enables content creators to immortalize 
                    their content and productions as NFTs. In this way, musicians, producers, creators of any 
                    content of interest can rapidly monetize on their talent within the Events Ecosystem.</p>
                </div>
            </div>
        </div>
    )
