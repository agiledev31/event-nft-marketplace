...
import { validateEmail, validateHtmlEditorValue } from '../../../utils';
...
const PageMessageCreate = () => {
    ...
    const handleCreate = () => {
        ...
        createMessage({...values, content: values.content.toString('html')}).then(res => {
            setLoading(false);
            if (res.success) {
                addToast('Created Email', {appearance: 'success', autoDismiss: true});
                navigate('/');
            } else {
                        ...
                        <form action="#" className="sign__form sign__form--create">
                            <div className="row">
                                <div className="col-12">
                                    <h4 className="sign__title" style={{marginBottom: '10px'}}>Receiver</h4>
                                </div>

                                <div className="col-12">
                                    <input id="receiver" type="text" name="receiver" className="sign__input"
                                                placeholder="e. g. 'john@gmail.com'" 
                                                value={values.receiver}
                                                onChange={e => handleChange('receiver', e.target.value)}        
                                        />
                                    {validations.receiver == 'has-empty' ? (<span className='text-error'>Receiver Required*</span>) : ''}
                                    {validations.receiver == 'has-danger' ? (<span className='text-error'>Receiver should be email.</span>) : ''}
                                </div>
                                ...
                                <div className="col-12">
                                    <div className="sign__group">
                                        <label className="sign__label" htmlFor="itemname">Link</label>
                                        ...
                                        {validations.link == 'has-empty' ? (<span className='text-error'>Link Required*</span>) : ''}
                                    </div>
                                </div>

                                <div className="col-12">
                                    <div className="sign__group">
                                        <label className="sign__label" htmlFor="description">Content</label>
                                        ...
                                        {validations.content == 'has-empty' ? (<span className='text-error'>Content Required*</span>) : ''}
                                    </div>
                                </div>

                                <div className="col-12 col-xl-3">
                                    <button type="button" className="sign__btn" onClick={handleCreate}>Create Email</button>
                                </div>
                            </div>
                        </form>
                    </div>
